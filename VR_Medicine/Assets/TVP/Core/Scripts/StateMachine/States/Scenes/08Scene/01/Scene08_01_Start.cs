...
{
    public class Scene08_01_Start : SimDomenState
    {
        public Scene08_01_Start(SimDomenStateMachine stateMachine) : base(stateMachine)
        {
            StateType = StateTypeEnum.SceneIsStart_08_01;
            CurrentStep = 0;
            TotalSteps = 7;
            ...
            Description = "Не отпускать педаль";
        }
