...
{
    public class Scene08_01_03_PutNiddleAtAntisepticFluid_08_01_03 : SimDomenState
    {
        public Scene08_01_03_PutNiddleAtAntisepticFluid_08_01_03(SimDomenStateMachine stateMachine) : base(stateMachine)
        {
            StateType = StateTypeEnum.PutNiddleAtAntisepticFluid_08_01_03;
            CurrentStep = 3;
            TotalSteps = 7;
            ...
            Description = "Промыть иглу и только потом отпустить педаль";
        }
