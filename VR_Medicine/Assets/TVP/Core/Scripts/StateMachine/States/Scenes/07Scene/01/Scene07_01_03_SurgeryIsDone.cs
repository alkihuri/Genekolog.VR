...
{
    public class Scene07_01_03_SurgeryIsDone : SimDomenState
    {
        public Scene07_01_03_SurgeryIsDone(SimDomenStateMachine stateMachine) : base(stateMachine)
        {
            StateType = StateTypeEnum.SurgeryIsDone_07_01_03;
