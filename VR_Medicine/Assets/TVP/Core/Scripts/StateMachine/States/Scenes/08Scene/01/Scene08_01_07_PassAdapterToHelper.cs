...
{
    public class Scene08_01_07_PassAdapterToHelper : SimDomenState
    {
        public Scene08_01_07_PassAdapterToHelper(SimDomenStateMachine stateMachine) : base(stateMachine)
        {
            StateType = StateTypeEnum.PassAdapterToHelper_08_01_07;
            CurrentStep = 7;
            TotalSteps = 7;
